...
<div style='
    ...
    font-size : 0.9rem;
'>
 부산 시 교통혁신국장이, 서울시로 하면 도시교통실인데 그 사람이 시의회에서 나와서 한 얘기가 있어요. 부산시 의원이 "왜 재정 부담이 이렇게 많이 되는 거를 섣불리 합의를 했냐"라고 하니까 그 교통 혁신 국장, 부산시 책임 공무원이 "법에 따라서 올라온 걸 어떻게 안 지키냐", "그건 지키고 그 대신 **노조의 양보를 받아서** 임금 동결을 했다" (라고 말했다)
